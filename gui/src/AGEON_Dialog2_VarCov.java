...
public class AGEON_Dialog2_VarCov
    extends SageDialog
  ...
  public AGEON_Dialog2_VarCov(AGEON2 parent, String title) {
    super(title);
    this.parent = parent;
  ...
  private void jbInit() throws Exception {
    ...
    jLabel3.setText("<html>Specifies the <i>variance covariates</i> sub-block.");
    ...
    jComboBox2.addMouseListener(new AGEON_Dialog2_VarCov_jComboBox2_mouseAdapter(this));
    ...
    jTextField1.addMouseListener(new AGEON_Dialog2_VarCov_jTextField1_mouseAdapter(this));
    jComboBox1.addMouseListener(new AGEON_Dialog2_VarCov_jComboBox1_mouseAdapter(this));
  ...
  void onPressedF1()
  {
      ...
      Frame1.mainFrame1.pdfframe.setTextonPage("covariate ", false, 381);
  }
  ...
  void jComboBox1_mouseClicked(MouseEvent e) {
    ...
    Frame1.mainFrame1.pdfframe.setTextonPage(", val ", false, 381);
    }

    void jComboBox2_mouseClicked(MouseEvent e) {
    Frame1.mainFrame1.pdfframe.setTextonPage(", fixe", false, 381);
    }


}

class AGEON_Dialog2_VarCov_jComboBox1_mouseAdapter extends java.awt.event.MouseAdapter {
  AGEON_Dialog2_VarCov adaptee;

  AGEON_Dialog2_VarCov_jComboBox1_mouseAdapter(AGEON_Dialog2_VarCov adaptee) {
...
class AGEON_Dialog2_VarCov_jTextField1_mouseAdapter extends java.awt.event.MouseAdapter {
  AGEON_Dialog2_VarCov adaptee;

  AGEON_Dialog2_VarCov_jTextField1_mouseAdapter(AGEON_Dialog2_VarCov adaptee) {
    this.adaptee = adaptee;
  }
  public void mouseClicked(MouseEvent e) {
...
class AGEON_Dialog2_VarCov_jComboBox2_mouseAdapter extends java.awt.event.MouseAdapter {
  AGEON_Dialog2_VarCov adaptee;

  AGEON_Dialog2_VarCov_jComboBox2_mouseAdapter(AGEON_Dialog2_VarCov adaptee) {
    this.adaptee = adaptee;
  }
  public void mouseClicked(MouseEvent e) {
