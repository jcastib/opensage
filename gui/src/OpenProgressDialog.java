...
public class OpenProgressDialog extends JInternalFrame implements ActionListener{
  ...
  public OpenProgressDialog(String title) {
    super(title);
    try {
      jbInit();
      pack();
  ...
  private void jbInit() throws Exception {
    ...
    this.setFrameIcon(new ImageIcon(OpenProgressDialog.class.getResource("project.png")));
