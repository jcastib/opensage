...
public class SEGREG_Dialog5_MeanCov
    extends SageDialog
  ...
  public SEGREG_Dialog5_MeanCov(String title) {
    super(title);
  ...
  private void jbInit() throws Exception {
    ...
    jLabel3.setText("<html>Specifies covariates for the mean.");
    ...
    jComboBox3.addMouseListener(new SEGREG_Dialog5_MeanCov_jComboBox3_mouseAdapter(this));
    ...
    jComboBox2.addMouseListener(new SEGREG_Dialog5_MeanCov_jComboBox2_mouseAdapter(this));
    jLabel6.setForeground(Color.red);
    jLabel6.setToolTipText("Covariate to modify the mean of a quantitative trait.");
    ...
    jTextField1.addMouseListener(new SEGREG_Dialog5_MeanCov_jTextField1_mouseAdapter(this));
    jComboBox1.addMouseListener(new SEGREG_Dialog5_MeanCov_jComboBox1_mouseAdapter(this));
  ...
  public void save_init_state(){
    ...
    Datamodel.setValue("mean_cov", "use");
  ...
  void onPressedF1()
  {
      Frame1.mainFrame1.jMenuHelpPDF_actionPerformed();
       Frame1.mainFrame1.pdfframe.setTextonPage("covariate", false, 155);
  }
  ...
  void jTextField1_mouseClicked(MouseEvent e) {
    Frame1.mainFrame1.pdfframe.setTextonPage("val", false, 155);
  }

  void jComboBox2_mouseClicked(MouseEvent e) {
    Frame1.mainFrame1.pdfframe.setTextonPage("fixed", false, 155);
  }

  void jComboBox3_mouseClicked(MouseEvent e) {
    Frame1.mainFrame1.pdfframe.setTextonPage("interaction", false, 155);
  }
}

class SEGREG_Dialog5_MeanCov_jComboBox1_mouseAdapter extends java.awt.event.MouseAdapter {
  SEGREG_Dialog5_MeanCov adaptee;

  SEGREG_Dialog5_MeanCov_jComboBox1_mouseAdapter(SEGREG_Dialog5_MeanCov adaptee) {
...
class SEGREG_Dialog5_MeanCov_jTextField1_mouseAdapter extends java.awt.event.MouseAdapter {
  SEGREG_Dialog5_MeanCov adaptee;

  SEGREG_Dialog5_MeanCov_jTextField1_mouseAdapter(SEGREG_Dialog5_MeanCov adaptee) {
    this.adaptee = adaptee;
  }
  public void mouseClicked(MouseEvent e) {
...
class SEGREG_Dialog5_MeanCov_jComboBox2_mouseAdapter extends java.awt.event.MouseAdapter {
  SEGREG_Dialog5_MeanCov adaptee;

  SEGREG_Dialog5_MeanCov_jComboBox2_mouseAdapter(SEGREG_Dialog5_MeanCov adaptee) {
    this.adaptee = adaptee;
  }
  public void mouseClicked(MouseEvent e) {
...
class SEGREG_Dialog5_MeanCov_jComboBox3_mouseAdapter extends java.awt.event.MouseAdapter {
  SEGREG_Dialog5_MeanCov adaptee;

  SEGREG_Dialog5_MeanCov_jComboBox3_mouseAdapter(SEGREG_Dialog5_MeanCov adaptee) {
    this.adaptee = adaptee;
  }
  public void mouseClicked(MouseEvent e) {
