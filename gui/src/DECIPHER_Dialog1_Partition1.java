...
public class DECIPHER_Dialog1_Partition1
    extends SageDialog
  ...
  public DECIPHER_Dialog1_Partition1(DECIPHER2 parent, String title) {
    super(title);
    this.parent = parent;
    try {
      jbInit();
  ...
  private void jbInit() throws Exception {
    ...
    jLabel3.setText("Specifies the first level partition variable.");
    jLabel6.setToolTipText(
            "Indicate the variable to specify the first level partition.");
    ...
    jLabel4.setToolTipText(
            "<html>Specifies value of the partition variable common<br>to all individuals in this subpopulation.");
    jLabel4.setText("Partition value");
    jTextField2.setEnabled(false);
    jTextField2.addMouseListener(new DECIPHER_Dialog1_Partition1_jTextField2_mouseAdapter(this));
    jTextField1.setEnabled(false);
    jTextField1.setText("");
    jTextField1.addMouseListener(new DECIPHER_Dialog1_Partition1_jTextField1_mouseAdapter(this));
    jComboBox1.addMouseListener(new DECIPHER_Dialog1_Partition1_jComboBox1_mouseAdapter(this));
  ...
  public void save_init_state()
  {
    ...
    Datamodel.setValue("partition1_info", partition);
    Datamodel.setValue("partition1", "use");
...
class DECIPHER_Dialog1_Partition1_jComboBox1_mouseAdapter extends java.awt.event.MouseAdapter {
  DECIPHER_Dialog1_Partition1 adaptee;

  DECIPHER_Dialog1_Partition1_jComboBox1_mouseAdapter(DECIPHER_Dialog1_Partition1 adaptee) {
...
class DECIPHER_Dialog1_Partition1_jTextField1_mouseAdapter extends java.awt.event.MouseAdapter {
  DECIPHER_Dialog1_Partition1 adaptee;

  DECIPHER_Dialog1_Partition1_jTextField1_mouseAdapter(DECIPHER_Dialog1_Partition1 adaptee) {
    this.adaptee = adaptee;
  }
  public void mouseClicked(MouseEvent e) {
...
class DECIPHER_Dialog1_Partition1_jTextField2_mouseAdapter extends java.awt.event.MouseAdapter {
  DECIPHER_Dialog1_Partition1 adaptee;

  DECIPHER_Dialog1_Partition1_jTextField2_mouseAdapter(DECIPHER_Dialog1_Partition1 adaptee) {
    this.adaptee = adaptee;
  }
  public void mouseClicked(MouseEvent e) {
