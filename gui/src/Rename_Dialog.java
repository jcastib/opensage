...
public class Rename_Dialog extends JDialog implements DocumentListener, ActionListener{
  ...
  public Rename_Dialog(Frame frame, String title, boolean modal) {
  ...
  private void jbInit() throws Exception {
    ...
    jLabel8.setIcon(new ImageIcon(Rename_Dialog.class.getResource("project.png")));
    jLabel1.setText("Please rename your project.");
    ...
    jMiddlePanel.setPreferredSize(new Dimension(400,120));
