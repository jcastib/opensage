...
public class AGEON_Dialog3_SusCov
    extends SageDialog
  ...
  public AGEON_Dialog3_SusCov(AGEON2 parent, String title) {
    super(title);
    this.parent = parent;
  ...
  private void jbInit() throws Exception {
    ...
    jLabel3.setText(
        "<html>Specifies the <i>susceptibility covariates</i> sub-block.");
    ...
    jComboBox2.addMouseListener(new AGEON_Dialog3_SusCov_jComboBox2_mouseAdapter(this));
    ...
    jTextField1.addMouseListener(new AGEON_Dialog3_SusCov_jTextField1_mouseAdapter(this));
    jComboBox1.addMouseListener(new AGEON_Dialog3_SusCov_jComboBox1_mouseAdapter(this));
    ...
    jPanel1.add(jComboBox2,      new XYConstraints(200, 35, 60, 20));
  ...
  void onPressedF1()
  {
      ...
      Frame1.mainFrame1.pdfframe.setTextonPage("covariate ", false, 382);
  }
  ...
  void jTextField1_mouseClicked(MouseEvent e) {
    Frame1.mainFrame1.pdfframe.setTextonPage(", val ", false, 382);
  }

  void jComboBox2_mouseClicked(MouseEvent e) {
    Frame1.mainFrame1.pdfframe.setTextonPage(", fixe", false, 382);
  }
}

class AGEON_Dialog3_SusCov_jComboBox1_mouseAdapter extends java.awt.event.MouseAdapter {
  AGEON_Dialog3_SusCov adaptee;

  AGEON_Dialog3_SusCov_jComboBox1_mouseAdapter(AGEON_Dialog3_SusCov adaptee) {
...
class AGEON_Dialog3_SusCov_jTextField1_mouseAdapter extends java.awt.event.MouseAdapter {
  AGEON_Dialog3_SusCov adaptee;

  AGEON_Dialog3_SusCov_jTextField1_mouseAdapter(AGEON_Dialog3_SusCov adaptee) {
    this.adaptee = adaptee;
  }
  public void mouseClicked(MouseEvent e) {
...
class AGEON_Dialog3_SusCov_jComboBox2_mouseAdapter extends java.awt.event.MouseAdapter {
  AGEON_Dialog3_SusCov adaptee;

  AGEON_Dialog3_SusCov_jComboBox2_mouseAdapter(AGEON_Dialog3_SusCov adaptee) {
    this.adaptee = adaptee;
  }
  public void mouseClicked(MouseEvent e) {
